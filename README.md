...
2. View your own IP geolocation
3. Search any IPv4 address and view geolocation
4. See a searchable history of IPs and pin locations on the map
5. Delete history items and click history to re-fetch
